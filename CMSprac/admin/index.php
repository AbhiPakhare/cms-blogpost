...
//            $element_count = [$post_counts, $post_published_counts ,$post_draft_counts , $comments_counts, $comment_unapproved_counts ,$users_counts ,$subscriber_counts, $categories_counts];
//
//            for($i = 0;i<8;$i++){
